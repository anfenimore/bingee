...
function RemoveDetailsScreen({ route }) {
  ...
  //       }
  //     });
  //     navigation.navigate("ConfirmRemove");
  ...
  const removeFromList = async () => {
    ...
    const response = await fetch(
      "https://bingee-react.herokuapp.com/" + endPoint,
      {
        // method: "PUT",
        method: "DELETE",
        headers: {
...
export default RemoveDetailsScreen;
